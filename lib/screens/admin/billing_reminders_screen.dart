      ...
      body: Column(
        children: [
          AcademyPageHeader(
            compact: true,
            title: 'Cobrança',
            // Rota pushada (Menu > Financeiro > Cobrança, ou agora também a
            // partir do Financeiro) — precisa do próprio botão de voltar, já
            // que o header compacto não tem AppBar por baixo. Espelha o
            // `automaticallyImplyLeading` que o AppBar antigo dava de graça.
