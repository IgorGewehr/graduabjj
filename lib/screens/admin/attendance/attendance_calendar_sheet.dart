...
/// Full-month calendar displayed in a modal bottom sheet.
/// Allows picking any past or current date, not future dates.
class AttendanceCalendarSheet extends StatefulWidget {
  final DateTime selectedDate;
  final ValueChanged<DateTime> onDateSelected;

  const AttendanceCalendarSheet({
    super.key,
  ...
  @override
  State<AttendanceCalendarSheet> createState() =>
