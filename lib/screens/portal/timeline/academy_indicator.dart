...
/// Academy indicator for multi-academy users (timeline version)
class TimelineAcademyIndicator extends ConsumerWidget {
  const TimelineAcademyIndicator({super.key});
